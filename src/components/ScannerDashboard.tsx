      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-primary-500 text-primary-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold mb-2">Scan Orders</h2>
            <p className="text-primary-100">Scan QR codes to validate orders</p>
          </div>

          <div className="bg-secondary-600 text-secondary-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold mb-2">Today's Queue</h2>
            <p className="text-secondary-100">View pending orders</p>
          </div>

          <div className="bg-accent-500 text-accent-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold mb-2">History</h2>
            <p className="text-accent-100">View scanned orders history</p>
          </div>
        </div>
      </div>
    </div>
